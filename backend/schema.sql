...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 16, 2025 at 07:39 AM
...
CREATE TABLE `artworks` (
  ...
  `availability` enum('in_stock','out_of_stock','made_to_order') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'in_stock',
...
CREATE TABLE `courier_serviceability_cache` (
  `id` int(10) UNSIGNED NOT NULL,
  `pickup_pincode` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  `delivery_pincode` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
  `weight` decimal(10,2) NOT NULL,
  `cod` tinyint(1) NOT NULL DEFAULT 0,
  `courier_data` text COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'JSON data of available couriers',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
...
(1, 1, 'uploads/custom-requests/68c2855e19ea14.31233524_giftbox.png', '2025-09-11 02:46:30'),
(2, 2, 'uploads/custom-requests/admin_68c3b95b0cf748.50349646_Screenshot_2025-08-19_110222.png', '2025-09-12 00:40:35'),
(3, 2, 'uploads/custom-requests/admin_68c3b96ac09dc7.23792864_Screenshot_2025-08-19_110222.png', '2025-09-12 00:40:50'),
(4, 3, 'uploads/custom-requests/cart_68c3d6898ac679.34186019_Screenshot_2025-08-13_200022.png', '2025-09-12 02:45:05'),
(5, 4, 'uploads/custom-requests/cart_68c3d716e4db56.32790334_giftbox.png', '2025-09-12 02:47:26'),
(6, 3, 'uploads/custom-requests/admin_68c3d75443ba16.17243950_giftbox.png', '2025-09-12 02:48:28'),
(7, 5, 'uploads/custom-requests/cart_68c3d889996fa4.88738438_Screenshot_2025-08-13_194304.png', '2025-09-12 02:53:37'),
(8, 1, 'uploads/custom-requests/admin_68c3d8bf0454d1.40723189_giftbox.png', '2025-09-12 02:54:31'),
(9, 6, 'uploads/custom-requests/cart_68c3d95a7217c7.86892870_giftbox.png', '2025-09-12 02:57:06'),
(10, 7, 'uploads/custom-requests/cart_68c3da2a964ba6.21480005_giftbox.png', '2025-09-12 03:00:34'),
(11, 8, 'uploads/custom-requests/cart_68c3dad16ba016.50878251_giftbox.png', '2025-09-12 03:03:21'),
(12, 9, 'uploads/custom-requests/cart_68c3f1fcee73d5.43732643_Screenshot_2024-07-26_192946.png', '2025-09-12 04:42:12'),
(13, 10, 'uploads/custom-requests/cart_68c3f315b41b92.89872427_Screenshot_2025-08-06_215747.png', '2025-09-12 04:46:53'),
(14, 11, 'uploads/custom-requests/68c3f774d06da0.88489536_giftbox.png', '2025-09-12 05:05:32'),
(15, 12, 'uploads/custom-requests/cart_68c4f321f10f91.48701177_Screenshot_2025-08-13_194304.png', '2025-09-12 22:59:21'),
(16, 13, 'uploads/custom-requests/cart_68c5061b7f7669.76286331_Screenshot_2025-08-13_195837.png', '2025-09-13 00:20:19'),
(17, 14, 'uploads/custom-requests/cart_68c5af2dc7ebb9.90802846_Screenshot_2025-08-13_200022.png', '2025-09-13 12:21:41'),
(18, 14, 'uploads/custom-requests/admin_68c5af609b2450.52810488_Screenshot_2025-08-13_200022.png', '2025-09-13 12:22:32'),
(19, 15, 'uploads/custom-requests/68c7e87d755500.73900552_giftbox.png', '2025-09-15 04:50:45'),
(20, 16, 'uploads/custom-requests/68c7f0fc6e88c9.85452840_Screenshot_2025-08-13_194304.png', '2025-09-15 05:27:00'),
(21, 17, 'uploads/custom-requests/68ca3cd7935c03.43426036_Screenshot_2024-07-26_193102.png', '2025-09-16 23:15:11'),
(22, 18, 'uploads/custom-requests/cart_68cbbed4b19772.52544926_adb.jpg', '2025-09-18 02:42:04'),
...
CREATE TABLE `materials` (
  ...
  `size` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `color` varchar(60) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `grade` varchar(60) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `attributes_json` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Customer orders with Shiprocket integration';
...
CREATE TABLE `order_requirements` (
  ...
  `status` enum('pending','packed','fulfilled','cancelled') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `shipment_tracking_history` (
  `id` int(10) UNSIGNED NOT NULL,
  `order_id` int(11) NOT NULL,
  `awb_code` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
...
(1, 19, 2, 'pl_plink_RrlqUe3DtgkL2w', NULL, 'pending', NULL, NULL, 1, 12, 0, NULL, '{\"payment_method\":\"payment_link\"}', '2025-12-15 05:24:20', '2025-12-15 05:24:20');
...
CREATE TABLE `supplier_profiles` (
  `user_id` int(10) UNSIGNED NOT NULL,
  `shop_name` varchar(120) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
(16, 'jbjjbbjbb', 'approved', '2025-10-15 03:46:25', '2025-10-15 03:48:34'),
...
(2, 'cap embroidery', 'cap embroidery ', NULL, 'uploads/tutorials/videos/video_1765203120_6936dcb08a17e.mp4', NULL, 'beginner', '39.97', 0, '0', 5, '2025-12-08 14:12:00', '2025-12-08 14:12:00', 1),
(3, 'Mehandi Tutorial', ' simple Mehandi Tutorial', 'uploads/tutorials/thumb_1765858714_6940dd9a043c3.jpg', 'uploads/tutorials/videos/video_1765858714_6940dd9a03b50.mp4', NULL, 'beginner', '40.00', 0, '0', 5, '2025-12-16 04:18:34', '2025-12-16 04:18:34', 1),
(4, 'Watermelon Candle Making', 'Fruits candle  making', 'uploads/tutorials/thumb_1765859773_6940e1bd040c8.jpg', 'uploads/tutorials/videos/video_1765859773_6940e1bd03a51.mp4', NULL, 'beginner', '30.00', 0, '0', 5, '2025-12-16 04:36:13', '2025-12-16 04:36:13', 1),
(5, 'Pearl Jewelery', 'Perl jewelary', 'uploads/tutorials/thumb_1765861176_6940e73803c8c.jpg', 'uploads/tutorials/videos/video_1765861176_6940e738031ea.mp4', NULL, 'intermediate', '50.00', 0, '0', 5, '2025-12-16 04:59:36', '2025-12-16 04:59:36', 1),
(6, 'Mirror clay', 'Mirror clay', 'uploads/tutorials/thumb_1765862869_6940edd5a2af8.jpg', 'uploads/tutorials/videos/video_1765862869_6940edd5a24f5.mp4', NULL, 'intermediate', '40.00', 0, '0', 5, '2025-12-16 05:27:49', '2025-12-16 05:27:49', 1),
(7, 'Clock resin art', 'Clock resin art', 'uploads/tutorials/thumb_1765864371_6940f3b31d6a9.jpg', 'uploads/tutorials/videos/video_1765864371_6940f3b31cbfe.mp4', NULL, 'advanced', '59.99', 0, '0', 5, '2025-12-16 05:52:51', '2025-12-16 05:52:51', 1),
(8, 'Chocolate Boquetes', 'Chocolate Boquetes', 'uploads/tutorials/thumb_1765867087_6940fe4f3036d.jpg', 'uploads/tutorials/videos/video_1765867087_6940fe4f2f611.mp4', NULL, 'advanced', '49.97', 0, '0', 5, '2025-12-16 06:38:07', '2025-12-16 06:38:07', 1);
...
CREATE TABLE `users` (
  ...
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `razorpay_customer_id` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
